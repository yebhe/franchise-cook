...
const LoginPage = () => {
  ...
  // ✅ CORRECTION 1: useEffect pour rediriger si DÉJÀ connecté
  useEffect(() => {
    if (isAuthenticated) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // ✅ CORRECTION 2: Pas de redirection manuelle ici
        // Le useEffect va s'occuper de la redirection automatiquement
  ...
  // ✅ CORRECTION 3: Afficher un loading si déjà connecté
  if (isAuthenticated) {
    return (
      <>
        <Navigation />
