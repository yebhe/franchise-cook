...
const MesCamions = () => {
  ...
  const camionsFiltres = (camions || []).filter((camion) => {
    ...
    const matchStatus =
      statusFilter === "tous" || camion.statut === statusFilter;
  ...
  const getStatusColor = (statut) => {
    switch (statut) {
      case "attribue":
        return "mes-camions__badge--attribue";
      case "disponible":
        return "mes-camions__badge--disponible";
      case "maintenance":
        return "mes-camions__badge--maintenance";
      case "hors_service":
        return "mes-camions__badge--hors_service";
      default:
        return "mes-camions__badge--default";
    }
  };
      ...
      <div className="mes-camions__header">
        <div className="mes-camions__header-content">
          ...
          >
            <RefreshCw
              size={20}
              className={loading ? "mes-camions__icon--spinning" : ""}
            />
            Actualiser
          </button>
        </div>
            ...
            {camionsFiltres.map((camion) => (
              <div key={camion.id} className="mes-camions__card">
                ...
                <div className="mes-camions__card-header">
                  ...
                  <span
                    className={`mes-camions__badge ${getStatusColor(
                      camion.statut
                    )}`}
                  >
                ...
                <div className="mes-camions__card-content">
                  <div className="mes-camions__info-grid">
                    <div className="mes-camions__info-item">
                      <span className="mes-camions__info-label">
                        Immatriculation
                      </span>
