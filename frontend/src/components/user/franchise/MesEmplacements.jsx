...
const MesEmplacements = () => {
  ...
  //Filtrage des emplacements avec disponibilité
  const emplacementsFiltres = emplacements.filter((emplacement) => {
    ...
    const matchZone =
      zoneFilter === "tous" || emplacement.type_zone === zoneFilter;
  ...
  const getTypeZoneColor = (type) => {
    switch (type) {
      case "centre_ville":
        return "mes-emplacements__badge--centre";
      case "zone_commerciale":
        return "mes-emplacements__badge--commercial";
      case "parc":
        return "mes-emplacements__badge--parc";
      case "entreprise":
        return "mes-emplacements__badge--entreprise";
      case "marche":
        return "mes-emplacements__badge--marche";
      default:
        return "mes-emplacements__badge--default";
    }
  };
      ...
      return (
        <div className="mes-emplacements__statut mes-emplacements__statut--occupe">
          ...
          <div className="mes-emplacements__occupation-info">
            ...
            <small>
              Du {affectation.date_debut}{" "}
              {affectation.date_fin ? `au ${affectation.date_fin}` : ""}
            </small>
          </div>
        </div>
      );
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Chargement de vos emplacements autorisés...
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="mes-emplacements__container">
        ...
        <div className="mes-emplacements__header-content">
          <div className="mes-emplacements__title-section">
            ...
            <p className="mes-emplacements__subtitle">
              Consultez les emplacements où votre franchise peut installer ses
              camions
            </p>
          </div>
          <div className="mes-emplacements__header-actions">
            ...
            >
              <RefreshCw
                size={20}
                className={loading ? "mes-emplacements__icon--spinning" : ""}
              />
              Actualiser
            </button>
            <button
      ...
      {emplacements.length > 0 && (
        <div className="mes-emplacements__stats">
          <div className="mes-emplacements__stat-card">
            ...
            <div className="mes-emplacements__stat-label">
      ...
      {/*Filtres et recherche avec disponibilité */}
              ...
              <div key={emplacement.id} className="mes-emplacements__card">
                ...
                <div className="mes-emplacements__card-header">
                  ...
                  <div className="mes-emplacements__badges">
                    <span
                      className={`mes-emplacements__badge ${getTypeZoneColor(
                        emplacement.type_zone
                      )}`}
                    >
                ...
                <div className="mes-emplacements__card-content">
                  <div className="mes-emplacements__info-grid">
                    <div className="mes-emplacements__info-item">
                      ...
                      <span className="mes-emplacements__info-label">
                        Tarif journalier
                      </span>
                    ...
                    <div className="mes-emplacements__info-item">
                      <Clock
                        size={16}
                        className="mes-emplacements__info-icon"
                      />
                      <span className="mes-emplacements__info-label">
                        Horaires
                      </span>
                ...
                <div className="mes-emplacements__card-actions">
                  ...
                  {/* Bouton conditionnel selon disponibilité */}
      ...
      {showModal && selectedEmplacement && (
        <div className="mes-emplacements__modal-overlay" onClick={closeModal}>
          <div
            className="mes-emplacements__modal"
          ...
          >
            ...
            <div className="mes-emplacements__modal-content">
              {/* Statut en évidence dans la modal */}
                  ...
                  <div className="mes-emplacements__detail-list">
                    ...
                    <div className="mes-emplacements__detail-item">
                      ...
                      <span className="mes-emplacements__detail-value">
                        ...
                        {selectedEmplacement.code_postal}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mes-emplacements__detail-section">
                  ...
                  <div className="mes-emplacements__detail-list">
                    ...
                    <div className="mes-emplacements__detail-item">
                      ...
                      <span className="mes-emplacements__detail-value">
                        {selectedEmplacement.horaires_autorises ||
                          "Non spécifié"}
                      </span>
                    </div>
                  </div>

                  {/*Actions conditionnelles dans la modal */}
                  <div className="mes-emplacements__modal-actions">
                    {selectedEmplacement.est_disponible ? (
                      ...
                      <div className="mes-emplacements__modal-warning">
                        <Info size={16} />
                        <span>
                          Cet emplacement est actuellement occupé et ne peut pas
                          recevoir de nouvelle affectation.
                        </span>
                      </div>
                    )}
                  </div>
