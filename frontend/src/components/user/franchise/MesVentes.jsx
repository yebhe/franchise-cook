...
const MesVentes = () => {
  ...
  const calculerStats = (ventesData) => {
    ...
    const total_ca = ventesData.reduce(
      (sum, vente) => sum + (vente.chiffre_affaires_jour || 0),
      0
    );
    const total_redevance = ventesData.reduce(
      (sum, vente) => sum + (vente.redevance_due || 0),
      0
    );
    const jours_activite = ventesData.length;
    const moyenne_quotidienne =
      jours_activite > 0 ? total_ca / jours_activite : 0;
  ...
  const validateForm = () => {
    ...
    if (!form.nombre_transactions) {
      ...
      errors.nombre_transactions =
        "Le nombre de transactions doit être positif";
    }
  ...
  const genererRapport = async () => {
    try {
      ...
      const response = await apiClient.get(
        `/api_user/rapports/ventes/?mois=${dateFilter}`,
        {
        ...
        <div className="mes-ventes__header-content">
          ...
          <div className="mes-ventes__header-actions">
            ...
            >
              <RefreshCw
                size={20}
                className={loading ? "mes-ventes__icon--spinning" : ""}
              />
              Actualiser
            </button>
            <button
      ...
      <div className="mes-ventes__stats">
        <div className="mes-ventes__stat-card">
          ...
          <div className="mes-ventes__stat-content">
            <h3 className="mes-ventes__stat-value">
              {formatCurrency(statsData.ventes_30j?.chiffre_affaires)}
            </h3>
        ...
        <div className="mes-ventes__stat-card">
          ...
          <div className="mes-ventes__stat-content">
            <h3 className="mes-ventes__stat-value">
              {formatCurrency(statsData.commandes_en_cours)}
            </h3>
        ...
        <div className="mes-ventes__stat-card">
          ...
          <div className="mes-ventes__stat-content">
            <h3 className="mes-ventes__stat-value">
              {formatCurrency(statsData.ventes_30j?.redevance_due)}
            </h3>
        ...
        <div className="mes-ventes__stat-card">
          ...
          <div className="mes-ventes__stat-content">
            <h3 className="mes-ventes__stat-value">
              {formatNumber(stats.jours_activite)}
            </h3>
                ...
                <div className="mes-ventes__card-content">
                  <div className="mes-ventes__info-grid">
                    <div className="mes-ventes__info-item">
                      <span className="mes-ventes__info-label">
                        Chiffre d'affaires
                      </span>
                    ...
                    <div className="mes-ventes__info-item">
                      ...
                      <span className="mes-ventes__info-value">
                        {vente.nombre_transactions > 0
                          ? formatCurrency(
                              vente.chiffre_affaires_jour /
                                vente.nombre_transactions
                            )
                          : formatCurrency(0)}
                      </span>
                    </div>
                ...
                <div className="mes-ventes__form-group">
                  ...
                  >
                    ...
                    {validationErrors.date_vente && (
                      <AlertTriangle
                        size={14}
                        className="mes-ventes__error-icon"
                      />
                    )}
                  </label>
                  <input
                    ...
                    className={`mes-ventes__input ${
                      validationErrors.date_vente
                        ? "mes-ventes__input--error"
                        : ""
                    }`}
                  />
                  {validationErrors.date_vente && (
                    <span className="mes-ventes__error-text">
                      {validationErrors.date_vente}
                    </span>
                  )}
                </div>
                ...
                <div className="mes-ventes__form-group">
                  ...
                  <div className="mes-ventes__calculated-field">
                    {form.chiffre_affaires_jour
                      ? formatCurrency(
                          parseFloat(form.chiffre_affaires_jour) * 0.04
                        )
                      : formatCurrency(0)}
                  </div>
                </div>
              ...
              {form.chiffre_affaires_jour && form.nombre_transactions && (
                <div className="mes-ventes__form-summary">
                  <div className="mes-ventes__summary-item">
                    ...
                    <span>
                      {formatCurrency(
                        parseFloat(form.chiffre_affaires_jour) /
                          parseInt(form.nombre_transactions)
                      )}
                    </span>
                  </div>
                </div>
                ...
                >
                  {submitLoading ? (
                    <>
                      <Loader
                        size={16}
                        className="mes-ventes__icon--spinning"
                      />
