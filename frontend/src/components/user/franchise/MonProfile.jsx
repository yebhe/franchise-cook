...
const MonProfile = () => {
  ...
  const getStatutColor = (statut) => {
    switch (statut) {
      case "actif":
        return "mon-profil__status--active";
      case "inactif":
        return "mon-profil__status--inactive";
      case "suspendu":
        return "mon-profil__status--suspended";
      default:
        return "mon-profil__status--default";
    }
  };
        ...
        <div className="mon-profil__header-content">
          ...
          <div className="mon-profil__header-actions">
            ...
            >
              <RefreshCw
                size={20}
                className={loading ? "mon-profil__icon--spinning" : ""}
              />
              Actualiser
            </button>
            {!editing && (
                    ...
                    <div className="mon-profil__form-group">
                      ...
                      >
                        ...
                        {validationErrors.first_name && (
                          <AlertTriangle
                            size={14}
                            className="mon-profil__error-icon"
                          />
                        )}
                      </label>
                      <input
                        ...
                        className={`mon-profil__input ${
                          validationErrors.first_name
                            ? "mon-profil__input--error"
                            : ""
                        }`}
                      />
                      {validationErrors.first_name && (
                        <span className="mon-profil__error-text">
                          {validationErrors.first_name}
                        </span>
                      )}
                    </div>
                ...
                <div className="mon-profil__info-grid">
                  <div className="mon-profil__info-item">
                    ...
                    <span className="mon-profil__info-value">
                      {profil?.first_name || "Non renseigné"}
                    </span>
                  </div>
                  <div className="mon-profil__info-item">
                    <span className="mon-profil__info-label">Nom</span>
                    <span className="mon-profil__info-value">
                      {profil?.last_name || "Non renseigné"}
                    </span>
                  </div>
                </div>
              )}
          ...
          <div className="mon-profil__section">
            ...
            <div className="mon-profil__section-content">
              {editing ? (
                ...
                <div className="mon-profil__info-grid">
                  <div className="mon-profil__info-item">
                    <span className="mon-profil__info-label">
                      Nom de la franchise
                    </span>
                    <span className="mon-profil__info-value">
                      {profil.nom_franchise || "Non renseigné"}
                    </span>
                  </div>
                  <div className="mon-profil__info-item">
                    <span className="mon-profil__info-label">Adresse</span>
                    <span className="mon-profil__info-value">
                      {profil.adresse || "Non renseignée"}
                    </span>
                  </div>
                  <div className="mon-profil__info-item">
                  ...
                  <div className="mon-profil__info-item">
                    ...
                    <span className="mon-profil__info-value">
                      {profil.code_postal || "Non renseigné"}
                    </span>
                  </div>
                  <div className="mon-profil__info-item">
                    <span className="mon-profil__info-label">Statut</span>
                    <span
                      className={`mon-profil__status ${getStatutColor(
                        profil.statut
                      )}`}
                    >
                      <Shield size={14} />
