        ...
        <div className="admin-dashboard">
          <div className="admin-dashboard__container">
            ...
            <div className="admin-dashboard__header">
              <h1 className="admin-dashboard__title">Tableau de bord administrateur</h1>
              <p className="admin-dashboard__subtitle">Vue d'ensemble de l'activité DRIV'N COOK</p>
            </div>
                ...
                <div className="admin-dashboard__actions">
                  {quickActions.map((action, index) => {
                    ...
                    return (
                      ...
                      >
                        <span className="admin-dashboard__action-text">{action.title}</span>
                  ...
                  {isLoading ? (
                    ...
                    <>
                      <div className="admin-dashboard__alert">
                        <AlertTriangle className="admin-dashboard__alert-icon admin-dashboard__alert-icon--warning" size={20} />
                        <div className="admin-dashboard__alert-content">
                          <p className="admin-dashboard__alert-title">Stock faible détecté</p>
                      ...
                      <div className="admin-dashboard__alert">
                        <CheckCircle className="admin-dashboard__alert-icon admin-dashboard__alert-icon--success" size={20} />
                        <div className="admin-dashboard__alert-content">
                          <p className="admin-dashboard__alert-title">Système opérationnel</p>
                          <p className="admin-dashboard__alert-description">
