...
import { Navigation, Plus, Edit, Trash2, Search, Filter } from "lucide-react";
import "./GestionAffectations.module.css";
...
export default function GestionAffectations() {
  ...
  const filteredAffectations = (affectations || []).filter((affectation) => {
    ...
    const matchesSearch =
      (getCamionNumero(affectation.camion) || "")
        .toLowerCase()
    ...
    const matchesStatut =
      statutFilter === "" || affectation.statut === statutFilter;
  ...
  return (
    <div className="gestion-affectations__container">
        ...
        <div className="gestion-affectations__header-content">
          <div className="gestion-affectations__title-section">
            <h1 className="gestion-affectations__title">
              <Navigation
                className="gestion-affectations__title-icon"
                size={32}
              />
              Envoi de Camions
            </h1>
      ...
      <div className="gestion-affectations__content">
                  ...
                  <tbody>
                    {filteredAffectations.length === 0 ? (
                      ...
                      filteredAffectations.map((affectation) => (
                        <tr
                          key={affectation.id}
                          className="gestion-affectations__table-row"
                        >
                          <td>
                          ...
                          <td>
                            <span
                              className={`gestion-affectations__badge gestion-affectations__badge--${affectation.statut}`}
                            >
        ...
        {showForm && (
          <div
            className="gestion-affectations__modal-overlay"
            onClick={resetForm}
          >
            <div
              className="gestion-affectations__modal"
            ...
            >
              ...
              <form
                ...
                className="gestion-affectations__form"
              >
