  ...
  const filteredMaintenances = (maintenances || []).filter((maintenance) => {
    ...
    const matchesSearch =
      ...
      (maintenance.garage || "")
        .toLowerCase()
        .includes(searchTerm.toLowerCase()) ||
      (getCamionNumero(maintenance.camion) || "")
        .toLowerCase()
        .includes(searchTerm.toLowerCase());

    const matchesType =
      typeFilter === "" || maintenance.type_maintenance === typeFilter;
  ...
  return (
    <div className="gestion-maintenance__container">
      ...
      <div className="gestion-maintenance__content">
                  ...
                  <tbody>
                    {filteredMaintenances.length === 0 ? (
                      ...
                      filteredMaintenances.map((maintenance) => (
                        <tr
                          key={maintenance.id}
                          className="gestion-maintenance__table-row"
                        >
                          <td>
                          ...
                          <td>
                            <span
                              className={`gestion-maintenance__badge gestion-maintenance__badge--${maintenance.type_maintenance}`}
                            >
                          ...
                          <td>
                            <span
                              className={`gestion-maintenance__badge gestion-maintenance__badge--${maintenance.statut}`}
                            >
        ...
        {showForm && (
          <div
            className="gestion-maintenance__modal-overlay"
            onClick={resetForm}
          >
            <div
              className="gestion-maintenance__modal"
            ...
            >
              ...
              <form
                ...
                className="gestion-maintenance__form"
              >
