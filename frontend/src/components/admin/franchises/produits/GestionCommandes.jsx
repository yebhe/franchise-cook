    ...
    <div className="gestion-commandes__container">
        ...
        <div className="gestion-commandes__header-content">
          <div className="gestion-commandes__title-section">
            ...
            <p className="gestion-commandes__subtitle">
              Administration : Workflow Entrepôt → Produits → Panier avec règle
              80/20
            </p>
          </div>
      ...
      <div className="gestion-commandes__info-banner">
        ...
        <div>
          ...
          Sélectionnez une franchise → choisissez un entrepôt → ajoutez vos
          produits → validez. 80% minimum du montant total doit provenir des
      ...
      <div className="gestion-commandes__filters">
        ...
        <div className="gestion-commandes__filters-row">
          <div className="gestion-commandes__filter">
            <Filter className="gestion-commandes__filter-icon" size={20} />
            <select
              value={statutFilter}
          ...
          <div className="gestion-commandes__filter">
            <Building className="gestion-commandes__filter-icon" size={20} />
            <select
          ...
          <div className="gestion-commandes__filter">
            <TrendingUp className="gestion-commandes__filter-icon" size={20} />
            <select
          ...
          <div className="gestion-commandes__filter">
            <Calendar className="gestion-commandes__filter-icon" size={20} />
            <input
              type="date"
              value={dateDebut}
      ...
      <div className="gestion-commandes__stats">
        <div className="gestion-commandes__stat-card">
          ...
          <div className="gestion-commandes__stat-content">
            ...
            <span className="gestion-commandes__stat-label">Commandes</span>
          </div>
        </div>
        ...
        <div className="gestion-commandes__stat-card">
          ...
          <div className="gestion-commandes__stat-content">
            ...
            <span className="gestion-commandes__stat-label">Non-conformes</span>
          </div>
        </div>
        ...
        <div className="gestion-commandes__stat-card">
          ...
          <div className="gestion-commandes__stat-content">
            ...
            <span className="gestion-commandes__stat-label">En attente</span>
          </div>
        </div>
      </div>
              ...
              <table className="gestion-commandes__table">
                ...
                <tbody>
                  {filteredCommandes.length === 0 ? (
                    <tr>
                      <td colSpan="8" className="gestion-commandes__empty">
                          ...
                          <td>
                            <div className="gestion-commandes__conformite">
                              ...
                              <small className="gestion-commandes__conformite-detail">
                                {conformite?.message || "Calcul en cours..."}
                              </small>
                            </div>
                          </td>
                          <td>
                            ...
                            <div className="gestion-commandes__actions">
                              ...
                              {commande.statut === "validee" && (
                                <button
                                  ...
                                  onClick={() => marquerPreparee(commande.id)}
      ...
      {showForm && (
        <div className="gestion-commandes__modal-overlay" onClick={resetForm}>
          <div
          ...
          >
            <div className="gestion-commandes__modal-header">
              <h3>
                {editingId ? "Modifier" : "Créer"} une commande multi-entrepôts
              </h3>
              <button
            ...
            <form onSubmit={handleSubmit} className="gestion-commandes__form">
              {error && (
                <div className="gestion-commandes__alert gestion-commandes__alert--error">
                  {error}
                </div>
              ...
              {!commandeForm.franchise && (
                <div className="gestion-commandes__help-message">
                  <Info size={16} />
                  <span>
                    Sélectionnez d'abord une franchise pour commencer à créer la
                    commande
                  </span>
                </div>
              )}
                      ...
                      >
                        ...
                        {conformite.montant_total > 0 && (
                          <div className="gestion-commandes__conformite-preview-details">
                            ...
                            <span>
                              Fournisseur libre:{" "}
                              {conformite.montant_fournisseur_libre.toFixed(2)}€
                            ...
                            (() => {
                              ...
                              if (franchise) {
                                const adresseAuto = [
                                  ...
                                  .filter(Boolean)
                                  .join(", ");
                                return adresseAuto || "Adresse non définie";
                              }
          ...
          >
            ...
            <div className="gestion-commandes__rapport">
              ...
              <div className="gestion-commandes__rapport-stats">
                ...
                <div className="gestion-commandes__rapport-stat">
                  <span className="gestion-commandes__rapport-stat-number">
                    {rapportConformite.statistiques.commandes_non_conformes}
                  </span>
                  <span className="gestion-commandes__rapport-stat-label">
                    Non conformes
                  </span>
                      ...
                      (commande) => (
                        ...
                        >
                          ...
                          <div className="gestion-commandes__rapport-item-details">
                            <span>
                              Montant total: {commande.montant_total.toFixed(2)}
                              €
                            </span>
              ...
              {rapportConformite.commandes_conformes.length > 0 && (
                <div className="gestion-commandes__rapport-section">
                  ...
                  <div className="gestion-commandes__rapport-list">
                    ...
                    {rapportConformite.commandes_conformes.length > 10 && (
