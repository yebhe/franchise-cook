...
export default function GestionStocks() {
  ...
  const filteredStocks = (stocks || []).filter((stock) => {
    ...
    const matchesEntrepot =
      entrepotFilter === "" || stock.entrepot === parseInt(entrepotFilter);
      ...
      <div className="gestion-stocks__content">
                  ...
                  <tbody>
                    {filteredStocks.length === 0 ? (
                      ...
                      filteredStocks.map((stock, i) => (
                        <tr
                          key={stock.id}
                          className="gestion-stocks__table-row"
                        >
                          <td>
                            <div className="gestion-stocks__produit">
                              <Package
                                size={16}
                                className="gestion-stocks__produit-icon"
                              />
        ...
        {showForm && (
          <div className="gestion-stocks__modal-overlay" onClick={resetForm}>
            <div
              className="gestion-stocks__modal"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="gestion-stocks__form">
                ...
                <div className="gestion-stocks__form-group">
                  <label htmlFor="quantite_disponible">
                    Quantité disponible *
                  </label>
                  <input
                    type="number"
