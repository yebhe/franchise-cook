// components/admin/categories/GestionCategories.jsx
...
export default function GestionCategories() {
  ...
  const filteredCategories = (categories || []).filter(categorie => {
    ...
    const matchesSearch = (
      (categorie.nom_categorie || '').toLowerCase().includes(searchTerm.toLowerCase()) ||
        ...
        <div className="gestion-categories">
          <div className="gestion-categories__container">
            ...
            <div className="gestion-categories__content">
                          ...
                          {filteredCategories.length === 0 ? (
                            <tr>
                              <td colSpan="3" className="gestion-categories__empty">
                                {(categories || []).length === 0 ? 'Aucune catégorie enregistrée' : 'Aucune catégorie trouvée'}
                              </td>
                            </tr>
                          ) : (
                            filteredCategories.map((categorie, i) => (
                              <tr key={categorie.id} className="gestion-categories__table-row">
                                <td>
              ...
              {/* Formulaire modal */}
              {showForm && (
                <div className="gestion-categories__modal-overlay" onClick={resetForm}>
                  <div className="gestion-categories__modal" onClick={(e) => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleSubmit} className="gestion-categories__form">
