...
export default function GestionEntrepots() {
  ...
  const getTypeEntrepotInfo = (type) => {
    return TYPE_ENTREPOT_OPTIONS.find(option => option.value === type) || TYPE_ENTREPOT_OPTIONS[0];
  };

  const getEntrepotStats = () => {
    const drivnCookCount = entrepots.filter(e => e.type_entrepot === 'drivn_cook' && e.statut === 'actif').length;
    const fournisseurLibreCount = entrepots.filter(e => e.type_entrepot === 'fournisseur_libre' && e.statut === 'actif').length;
  ...
  const filteredEntrepots = entrepots.filter(entrepot => {
    ...
    const matchesStatus = statusFilter === '' || entrepot.statut === statusFilter;
    const matchesType = typeFilter === '' || entrepot.type_entrepot === typeFilter;
  ...
  return (
    <div className="admin-layout">
      ...
      <main className="admin-main-content">
        <div className="gestion-entrepots">
          <div className="gestion-entrepots__container">
              ...
              <div className="gestion-entrepots__header-content">
                <div className="gestion-entrepots__title-section">
                  ...
                  <p className="gestion-entrepots__subtitle">
                    Gérer les entrepôts Driv'n Cook et fournisseurs libres pour la règle 80/20
                  </p>
                </div>
                <button 
            ...
            <div className="gestion-entrepots__stats">
              <div className="gestion-entrepots__stat-card gestion-entrepots__stat-card--drivn">
                ...
                <div className="gestion-entrepots__stat-content">
                  <div className="gestion-entrepots__stat-number">{stats.drivnCookCount}</div>
                  <div className="gestion-entrepots__stat-label">Entrepôts Driv'n Cook</div>
                  <div className="gestion-entrepots__stat-sublabel">80% obligatoire</div>
                </div>
              </div>
              ...
              <div className="gestion-entrepots__stat-card gestion-entrepots__stat-card--libre">
                ...
                <div className="gestion-entrepots__stat-content">
                  <div className="gestion-entrepots__stat-number">{stats.fournisseurLibreCount}</div>
                  <div className="gestion-entrepots__stat-label">Fournisseurs libres</div>
            ...
            <div className="gestion-entrepots__info-banner">
              <Info size={20} />
              <div>
                <strong>Règle 80/20 :</strong> Les franchisés doivent acheter 80% minimum de leur montant total 
            ...
            <div className="gestion-entrepots__content">
                          ...
                          {filteredEntrepots.length === 0 ? (
                            <tr>
                              <td colSpan="7" className="gestion-entrepots__empty">
                                {entrepots.length === 0 ? 'Aucun entrepôt enregistré' : 'Aucun entrepôt trouvé'}
                              </td>
                            </tr>
                          ) : (
                            filteredEntrepots.map((entrepot, i) => {
                              const typeInfo = getTypeEntrepotInfo(entrepot.type_entrepot);
                              const TypeIcon = typeInfo.icon;
                              
                              return (
                                <tr key={entrepot.id} className="gestion-entrepots__table-row">
                                  <td>
                                  ...
                                  <td>
                                    <div className={`gestion-entrepots__type-badge gestion-entrepots__type-badge--${typeInfo.color}`}>
                                      <TypeIcon size={16} />
                                      <span>
                                        {entrepot.type_entrepot === 'drivn_cook' ? 'Driv\'n Cook' : 'Fournisseur libre'}
                                      </span>
                                    </div>
                                  </td>
                                  <td>
                                    <div className="gestion-entrepots__responsable-info">
                                      <span>{entrepot.responsable || 'Non assigné'}</span>
                                    </div>
                                  </td>
                                  <td>
                                  ...
                                  <td>
                                    <span className={`gestion-entrepots__badge gestion-entrepots__badge--${entrepot.statut}`}>
                                      {entrepot.statut?.charAt(0).toUpperCase() + entrepot.statut?.slice(1)}
                                    </span>
                                  </td>
                                  <td>
              ...
              {showForm && (
                <div className="gestion-entrepots__modal-overlay" onClick={resetForm}>
                  <div className="gestion-entrepots__modal" onClick={(e) => e.stopPropagation()}>
                    ...
                    <form onSubmit={handleSubmit} className="gestion-entrepots__form">
                        ...
                        <div className="gestion-entrepots__type-options">
                          {TYPE_ENTREPOT_OPTIONS.map(option => {
                            ...
                            return (
                              <label 
                                key={option.value}
                                className={`gestion-entrepots__type-option ${form.type_entrepot === option.value ? 'gestion-entrepots__type-option--selected' : ''}`}
                              >
                                <input
                                  type="radio"
                                  name="type_entrepot"
                                ...
                                />
                                <div className={`gestion-entrepots__type-content gestion-entrepots__type-content--${option.color}`}>
                                  <OptionIcon size={20} />
                      ...
                      <div className={`gestion-entrepots__notice gestion-entrepots__notice--${form.type_entrepot === 'drivn_cook' ? 'green' : 'orange'}`}>
                        <div className="gestion-entrepots__notice-icon">
                          {form.type_entrepot === 'drivn_cook' ? '🏭' : '🚛'}
                        </div>
                        <div className="gestion-entrepots__notice-text">
                          <strong>
                            {form.type_entrepot === 'drivn_cook' ? 'Entrepôt Driv\'n Cook :' : 'Fournisseur libre :'}
                          </strong>
                          <p>
                            {form.type_entrepot === 'drivn_cook' 
                      ...
                      <div className="gestion-entrepots__form-group">
                        <label htmlFor="adresse">
                          Adresse complète *
                          {isGoogleMapsLoaded && <span className="gestion-entrepots__maps-badge">Google Maps</span>}
                        </label>
                        <div className="gestion-entrepots__address-group">
                          <div className="gestion-entrepots__address-wrapper">
                            <MapPin className="gestion-entrepots__address-icon" size={16} />
                            <input
                              ref={addressInputRef}
                              type="text"
                              id="adresse"
                              ...
                              onChange={handleChange}
                              required
                              className={`gestion-entrepots__input gestion-entrepots__input--with-icon ${addressValidated ? 'gestion-entrepots__input--validated' : ''}`}
                              placeholder="Commencez à taper l'adresse..."
                            />
                            {addressValidated && (
                              <CheckCircle className="gestion-entrepots__address-check" size={16} />
                            )}
                          </div>
                      ...
                      <div className="gestion-entrepots__form-row">
                        <div className="gestion-entrepots__form-group">
                          ...
                          <div className="gestion-entrepots__input-wrapper">
                            <User className="gestion-entrepots__input-icon" size={16} />
                            <input
                              type="text"
                              id="responsable"
                              name="responsable"
                        ...
                        <div className="gestion-entrepots__form-group">
                          ...
                          <div className="gestion-entrepots__input-wrapper">
                            <Phone className="gestion-entrepots__input-icon" size={16} />
                            <input
                              type="tel"
                              id="telephone"
                              name="telephone"
