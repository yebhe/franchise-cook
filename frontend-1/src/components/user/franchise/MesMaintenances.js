...
const MesMaintenances = () => {
  ...
  const getTypeMaintenanceColor = (type) => {
    switch (type) {
      case 'revision': return 'mes-maintenances__badge--revision';
      case 'reparation': return 'mes-maintenances__badge--reparation';
      case 'panne': return 'mes-maintenances__badge--panne';
      case 'controle_technique': return 'mes-maintenances__badge--controle';
      default: return 'mes-maintenances__badge--default';
    }
  };
  ...
  const getStatutColor = (statut) => {
    switch (statut) {
      case 'programme': return 'mes-maintenances__badge--programme';
      case 'en_cours': return 'mes-maintenances__badge--en_cours';
      case 'termine': return 'mes-maintenances__badge--termine';
      default: return 'mes-maintenances__badge--default';
    }
  };
  ...
  const getStatutIcon = (statut) => {
    switch (statut) {
      case 'programme': return <Clock size={14} />;
      case 'en_cours': return <Wrench size={14} />;
  ...
  // 1. Essayez d'abord avec camion_detail
    if (maintenance.camion_detail) {
      return `Camion ${maintenance.camion_detail.numero_camion || maintenance.camion}`;
    }
    
    // 2. Fallback avec l'ID du camion
    return maintenance.camion ? `Camion ${maintenance.camion}` : 'Camion inconnu';
  };
  ...
  const maintenancesFiltrees = maintenances.filter(maintenance => {
    ...
    const matchSearch = 
      ...
      (maintenance.garage && maintenance.garage.toLowerCase().includes(searchTerm.toLowerCase())) ||
      maintenance.date_maintenance.includes(searchTerm);
    
    const matchType = typeFilter === 'tous' || maintenance.type_maintenance === typeFilter;
    const matchStatut = statutFilter === 'tous' || maintenance.statut === statutFilter;
  ...
  const stats = {
    ...
    coutTotal: maintenances.reduce((sum, m) => sum + (parseFloat(m.cout) || 0), 0)
  };
  ...
  return (
    <div className="franchise-layout">
      ...
      <main className="franchise-main-content">
        <div className="mes-maintenances">
          <div className="mes-maintenances__container">
              ...
              <div className="mes-maintenances__header-content">
                <div className="mes-maintenances__title-section">
                  ...
                  <p className="mes-maintenances__subtitle">
                    Consultez l'historique des maintenances et réparations de vos camions
                  </p>
                </div>
                <div className="mes-maintenances__header-actions">
                  <button
                    ...
                    disabled={loading}
                  >
                    <RefreshCw size={20} className={loading ? 'mes-maintenances__icon--spinning' : ''} />
                    Actualiser
                  </button>
                </div>
              </div>
            ...
            <div className="mes-maintenances__info-banner">
              ...
              <span>
                <strong>Information :</strong> Cet espace vous permet de consulter l'historique des maintenances de vos camions. 
                Pour planifier de nouvelles maintenances, contactez votre responsable DRIV'N COOK.
              </span>
            </div>
            ...
            <div className="mes-maintenances__stats">
              <div className="mes-maintenances__stat-card">
                ...
                <div className="mes-maintenances__stat-content">
                  ...
                  <div className="mes-maintenances__stat-label">Total maintenances</div>
                </div>
              </div>
              ...
              <div className="mes-maintenances__stat-card">
                ...
                <div className="mes-maintenances__stat-content">
                  <div className="mes-maintenances__stat-value">{stats.programmes}</div>
              ...
              <div className="mes-maintenances__stat-card">
                ...
                <div className="mes-maintenances__stat-content">
                  <div className="mes-maintenances__stat-value">{formatPrice(stats.coutTotal)}</div>
              ...
              {maintenancesFiltrees.length === 0 ? (
                <div className="mes-maintenances__empty">
                  ...
                  <h3 className="mes-maintenances__empty-title">
                    {maintenances.length === 0 ? 'Aucune maintenance' : 'Aucune maintenance trouvée'}
                  </h3>
                    ...
                    <div key={maintenance.id} className="mes-maintenances__card">
                      ...
                      <div className="mes-maintenances__card-header">
                        <div className="mes-maintenances__card-info">
                          <div className="mes-maintenances__card-title">
                            <Truck size={18} className="mes-maintenances__card-icon" />
                            {getCamionInfo(maintenance)}
                          </div>
                          <div className="mes-maintenances__card-subtitle">
                            <Calendar size={16} className="mes-maintenances__card-icon" />
                            {formatDate(maintenance.date_maintenance)}
                          </div>
                        </div>
                        <div className="mes-maintenances__card-badges">
                          <span className={`mes-maintenances__badge ${getTypeMaintenanceColor(maintenance.type_maintenance)}`}>
                            {getTypeMaintenanceLabel(maintenance.type_maintenance)}
                          </span>
                          <span className={`mes-maintenances__badge ${getStatutColor(maintenance.statut)}`}>
                      ...
                      <div className="mes-maintenances__card-content">
                        <div className="mes-maintenances__description">
                          <h4 className="mes-maintenances__description-title">Description</h4>
                        ...
                        <div className="mes-maintenances__info-grid">
                          {maintenance.cout && (
                            <div className="mes-maintenances__info-item">
                              <Euro size={16} className="mes-maintenances__info-icon" />
                              <span className="mes-maintenances__info-label">Coût</span>
                          ...
                          {maintenance.garage && (
                            <div className="mes-maintenances__info-item">
                              <MapPin size={16} className="mes-maintenances__info-icon" />
                              <span className="mes-maintenances__info-label">Garage</span>
                              <span className="mes-maintenances__info-value">
                                {maintenance.garage}
                              </span>
                            </div>
